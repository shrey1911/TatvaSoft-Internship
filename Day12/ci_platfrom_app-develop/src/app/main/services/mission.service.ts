...
export class MissionService {
  ...
  getMissionThemeList(): Observable<MissionTheme[]> {
    // Corrected endpoint
    return this.http.get<MissionTheme[]>(`${this.apiUrl}/MissionTheme/GetAllMissionTheme`)
  }

  getMissionSkillList(): Observable<MissionSkill[]> {
    // Corrected endpoint
    return this.http.get<MissionSkill[]>(`${this.apiUrl}/MissionSkill/GetAllMissionSkill`)
  }
